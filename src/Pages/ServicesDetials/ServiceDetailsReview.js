...
const ServiceDetailsReview = ({ rv }) => {
    const { name, review, ratting, image } = rv;
    console.log(image)
        ...
        <div className="container  flex flex-col  max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 dark:dark:bg-gray-900 dark:dark:text-gray-100">
            <div className="flex justify-between p-4">
                <div className="flex space-x-4">
                    <div>
                        <img src={image} alt="" className="object-cover w-12 h-12 rounded-full dark:dark:bg-gray-500" />
                    </div>
                    <div>
            ...
            <div className="p-4 text-2xl space-y-2  dark:dark:text-gray-400">
                {review}
            </div>
        </div>
    );
